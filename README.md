...
* [PokeAPI](https://github.com/PokeAPI/pokeapi/) ⭐ 5,343 | 🐛 186 | 🌐 Python | 📅 2026-08-24 - A RESTful API for Pokémon (<http://pokeapi.co/>).
* [Kotlin-Pokedex](https://github.com/mrcsxsiq/Kotlin-Pokedex) ⭐ 1,552 | 🐛 32 | 🌐 Kotlin | 📅 2024-01-25 - Pokedex app built with Kotlin.
* [pgoapi](https://github.com/tejado/pgoapi) ⭐ 1,389 | 🐛 76 | 🌐 Protocol Buffer | 📅 2022-09-23 - Pokémon GO API lib/demo.
* [Pokemon GO Java API](https://github.com/Grover-c13/PokeGOAPI-Java) ⭐ 1,044 | 🐛 12 | 🌐 Java | 📅 2021-11-12 - Pokémon GO API for Java.
* [TCGdex](https://github.com/tcgdex/cards-database) ⭐ 1,022 | 🐛 153 | 🌐 TypeScript | 📅 2026-08-22 - Multi languages Pokémon TCG API.
...
* [Pokedex](https://github.com/skydoves/Pokedex) ⭐ 8,352 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-24 - Android Pokedex using Dagger, Hilt, Motion, Coroutines, Flow, and Jetpack.
* [Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) ⭐ 5,853 | 🐛 328 | 🌐 TypeScript | 📅 2026-08-23 - Pokémon battle simulator.
...
* [pokecrystal](https://github.com/pret/pokecrystal) ⭐ 2,494 | 🐛 59 | 🌐 Assembly | 📅 2026-08-13 - Disassembly of Pokémon Crystal.
