...
* [PokeAPI](https://github.com/PokeAPI/pokeapi/) ⭐ 5,363 | 🐛 183 | 🌐 Python | 📅 2026-08-29 - A RESTful API for Pokémon (<http://pokeapi.co/>).
...
* [TCGdex](https://github.com/tcgdex/cards-database) ⭐ 1,036 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-29 - Multi languages Pokémon TCG API.
...
* [Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) ⭐ 5,861 | 🐛 339 | 🌐 TypeScript | 📅 2026-08-29 - Pokémon battle simulator.
...
* [PokemonRedExperiments](https://github.com/PWhiddy/PokemonRedExperiments) ⭐ 7,898 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2025-08-28 - Playing Pokémon Red with Reinforcement Learning.
...
* [pokesprite](https://github.com/msikma/pokesprite) ⭐ 1,267 | 🐛 22 | 🌐 Python | 📅 2024-05-07 - Database of Pokémon sprites from the core series games, including custom shiny versions.
