...
* [PokeAPI](https://github.com/PokeAPI/pokeapi/) ⭐ 5,382 | 🐛 140 | 🌐 Python | 📅 2026-09-19 - A RESTful API for Pokémon (<http://pokeapi.co/>).
* [Kotlin-Pokedex](https://github.com/mrcsxsiq/Kotlin-Pokedex) ⭐ 1,553 | 🐛 33 | 🌐 Kotlin | 📅 2024-01-25 - Pokedex app built with Kotlin.
* [pgoapi](https://github.com/tejado/pgoapi) ⭐ 1,390 | 🐛 76 | 🌐 Protocol Buffer | 📅 2022-09-23 - Pokémon GO API lib/demo.
* [TCGdex](https://github.com/tcgdex/cards-database) ⭐ 1,079 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-21 - Multi languages Pokémon TCG API.
* [Pokemon GO Java API](https://github.com/Grover-c13/PokeGOAPI-Java) ⭐ 1,046 | 🐛 12 | 🌐 Java | 📅 2021-11-12 - Pokémon GO API for Java.
* [Pokemon-GO-node-api](https://github.com/Armax/Pokemon-GO-node-api) ⭐ 875 | 🐛 54 | 🌐 JavaScript | 📅 2019-05-27 - Pokémon GO API Node.js library.
* [Pokemon Name API](https://github.com/sindresorhus/pokemon) ⭐ 508 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-13 - Get a list of Pokémon names in JSON.
* [graphql-pokemon](https://github.com/lucasbento/graphql-pokemon) ⭐ 500 | 🐛 10 | 🌐 JavaScript | 📅 2022-12-06 - Get information of a Pokémon with GraphQL.
...
* [PokemonGO-Pokedex](https://github.com/Biuni/PokemonGO-Pokedex) ⭐ 134 | 🐛 1 | 📅 2017-01-28 - Pokédex of Pokémon GO in JSON.
...
* [Pokedex](https://github.com/skydoves/Pokedex) ⭐ 8,359 | 🐛 26 | 🌐 Kotlin | 📅 2026-09-19 - Android Pokedex using Dagger, Hilt, Motion, Coroutines, Flow, and Jetpack.
* [Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) ⭐ 5,901 | 🐛 327 | 🌐 TypeScript | 📅 2026-09-20 - Pokémon battle simulator.
...
* [PokemonGo-Bot](https://github.com/PokemonGoF/PokemonGo-Bot) ⭐ 3,923 | 🐛 173 | 🌐 Python | 📅 2023-12-07 - The Pokémon GO bot script, baking with community.
...
* [PokeSlack](https://github.com/timwah/pokeslack) ⭐ 36 | 🐛 17 | 🌐 Python | 📅 2016-08-10 - Alerts you of nearby Pokémon.
* [Pokemon Go Bot](https://github.com/Hrithikd/Pokemon-Go-Bot-Working-Hack-API) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2026-06-02 - Pokémon GO bot that farms for Pokestops and Pokémon.
...
* [PokemonRedExperiments](https://github.com/PWhiddy/PokemonRedExperiments) ⭐ 7,905 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Playing Pokémon Red with Reinforcement Learning.
* [pokered](https://github.com/pret/pokered) ⭐ 4,936 | 🐛 22 | 🌐 Assembly | 📅 2026-08-27 - Disassembly of Pokémon Red/Blue.
* [Pokemon-Terminal](https://github.com/LazoCoder/Pokemon-Terminal) ⭐ 4,803 | 🐛 47 | 🌐 Python | 📅 2026-02-25 - Pokémon terminal themes for iTerm2.
* [pokecrystal](https://github.com/pret/pokecrystal) ⭐ 2,504 | 🐛 60 | 🌐 Assembly | 📅 2026-08-28 - Disassembly of Pokémon Crystal.
...
* [pokesprite](https://github.com/msikma/pokesprite) ⭐ 1,278 | 🐛 22 | 🌐 Python | 📅 2024-05-07 - Database of Pokémon sprites from the core series games, including custom shiny versions.
...
* [slack-emoji-pokemon](https://github.com/Templarian/slack-emoji-pokemon) ⭐ 391 | 🐛 3 | 🌐 JavaScript | 📅 2022-04-11 - A list of Pokémon emojis for Slack.
...
* [Pokedex.org](https://github.com/nolanlawson/pokedex.org) ⭐ 2,274 | 🐛 49 | 🌐 JavaScript | 📅 2023-05-14 - Offline-capable Pokédex web site <https://pokedex.org>.
