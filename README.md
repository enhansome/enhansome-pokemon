...
* [PokeAPI](https://github.com/PokeAPI/pokeapi/) ⭐ 5,340 | 🐛 189 | 🌐 Python | 📅 2026-08-23 - A RESTful API for Pokémon (<http://pokeapi.co/>).
...
* [TCGdex](https://github.com/tcgdex/cards-database) ⭐ 1,020 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-22 - Multi languages Pokémon TCG API.
...
* [Pokedex](https://github.com/skydoves/Pokedex) ⭐ 8,354 | 🐛 25 | 🌐 Kotlin | 📅 2026-08-19 - Android Pokedex using Dagger, Hilt, Motion, Coroutines, Flow, and Jetpack.
* [Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) ⭐ 5,848 | 🐛 326 | 🌐 TypeScript | 📅 2026-08-23 - Pokémon battle simulator.
...
* [PokemonGo-Bot](https://github.com/PokemonGoF/PokemonGo-Bot) ⭐ 3,915 | 🐛 172 | 🌐 Python | 📅 2023-12-07 - The Pokémon GO bot script, baking with community.
...
* [Pokemon-Terminal](https://github.com/LazoCoder/Pokemon-Terminal) ⭐ 4,794 | 🐛 47 | 🌐 Python | 📅 2026-02-25 - Pokémon terminal themes for iTerm2.
...
* [pokesprite](https://github.com/msikma/pokesprite) ⭐ 1,264 | 🐛 22 | 🌐 Python | 📅 2024-05-07 - Database of Pokémon sprites from the core series games, including custom shiny versions.
