...
* [PokeAPI](https://github.com/PokeAPI/pokeapi/) ⭐ 5,321 | 🐛 186 | 🌐 Python | 📅 2026-08-11 - A RESTful API for Pokémon (<http://pokeapi.co/>).
* [Kotlin-Pokedex](https://github.com/mrcsxsiq/Kotlin-Pokedex) ⭐ 1,550 | 🐛 32 | 🌐 Kotlin | 📅 2024-01-25 - Pokedex app built with Kotlin.
* [pgoapi](https://github.com/tejado/pgoapi) ⭐ 1,391 | 🐛 76 | 🌐 Protocol Buffer | 📅 2022-09-23 - Pokémon GO API lib/demo.
* [Pokemon GO Java API](https://github.com/Grover-c13/PokeGOAPI-Java) ⭐ 1,045 | 🐛 12 | 🌐 Java | 📅 2021-11-12 - Pokémon GO API for Java.
* [TCGdex](https://github.com/tcgdex/cards-database) ⭐ 988 | 🐛 164 | 🌐 TypeScript | 📅 2026-08-13 - Multi languages Pokémon TCG API.
* [Pokemon-GO-node-api](https://github.com/Armax/Pokemon-GO-node-api) ⭐ 877 | 🐛 54 | 🌐 JavaScript | 📅 2019-05-27 - Pokémon GO API Node.js library.
* [Pokemon Name API](https://github.com/sindresorhus/pokemon) ⭐ 509 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-13 - Get a list of Pokémon names in JSON.
* [graphql-pokemon](https://github.com/lucasbento/graphql-pokemon) ⭐ 501 | 🐛 10 | 🌐 JavaScript | 📅 2022-12-06 - Get information of a Pokémon with GraphQL.
* [Pokemon-Go-Rocket-API](https://github.com/FeroxRev/Pokemon-Go-Rocket-API) ⭐ 360 | 🐛 59 | 🌐 C# | 📅 2016-08-16 - Client API library for Pokémon GO in C#.
* [PokemonGO-Pokedex](https://github.com/Biuni/PokemonGO-Pokedex) ⭐ 133 | 🐛 1 | 📅 2017-01-28 - Pokédex of Pokémon GO in JSON.
* [pokemon-API](https://github.com/Purukitto/pokemon-api) ⭐ 31 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-25 - Beginner friendly API endpoint that returns Pokémon Data in JSON format (<https://app.pokemon-api.xyz>).
* [PokeTypes](https://github.com/fbosch/poke-types) ⭐ 8 | 🐛 11 | 🌐 JavaScript | 📅 2023-01-03 - Get Pokémon types, weaknesses and strengths.

#### Apps

* [Pokedex](https://github.com/skydoves/Pokedex) ⭐ 8,351 | 🐛 26 | 🌐 Kotlin | 📅 2026-08-13 - Android Pokedex using Dagger, Hilt, Motion, Coroutines, Flow, and Jetpack.
* [Pokemon-Showdown](https://github.com/Zarel/Pokemon-Showdown) ⭐ 5,829 | 🐛 321 | 🌐 TypeScript | 📅 2026-08-12 - Pokémon battle simulator.
* [iPokeMon](https://github.com/Kjuly/iPokeMon) ⭐ 423 | 🐛 9 | 🌐 Objective-C | 📅 2016-08-26 - Pokémon like game on iOS with Location Based Service.
...
* [PokemonGo-Bot](https://github.com/PokemonGoF/PokemonGo-Bot) ⭐ 3,909 | 🐛 172 | 🌐 Python | 📅 2023-12-07 - The Pokémon GO bot script, baking with community.
* [PokemonGoBot](https://github.com/jabbink/PokemonGoBot) ⚠️ Archived - Bot that plays Pokémon GO.
* [PokeBuddy](https://github.com/finndev/PokeBuddy) ⭐ 440 | 🐛 977 | 📅 2020-07-26 - A Pokémon GO bot.
* [slack-pokemon](https://github.com/rvinluan/slack-pokemon) ⭐ 341 | 🐛 8 | 🌐 JavaScript | 📅 2017-05-10 - A bot for having Pokémon battles in Slack.
* [Poketrainer](https://github.com/j-e-k/poketrainer) ⚠️ Archived - A fast and feature filled bot in Python.
* [TwitchPlaysPokemon](https://github.com/sunshinekitty/TwitchPlaysPokemon) ⚠️ Archived - A bot mimicking Twitch Plays Pokémon.
* [PokeSlack](https://github.com/timwah/pokeslack) ⭐ 35 | 🐛 17 | 🌐 Python | 📅 2016-08-10 - Alerts you of nearby Pokémon.
* [Pokemon Go Bot](https://github.com/Hrithikd/Pokemon-Go-Bot-Working-Hack-API) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2026-06-02 - Pokémon GO bot that farms for Pokestops and Pokémon.
* [Bot Builder for PokemonGoBot](https://github.com/shilch/pogobot-builder) ⚠️ Archived - Simply build your Pokémon GO bot.
* [PokeBot](https://github.com/akbaryahya/PokeBot) ⚠️ Archived - The automated Pokémon speedrunning machine.

#### Miscellaneous

* [PokemonRedExperiments](https://github.com/PWhiddy/PokemonRedExperiments) ⭐ 7,892 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2025-08-28 - Playing Pokémon Red with Reinforcement Learning.
* [pokered](https://github.com/pret/pokered) ⭐ 4,876 | 🐛 22 | 🌐 Assembly | 📅 2026-08-10 - Disassembly of Pokémon Red/Blue.
* [Pokemon-Terminal](https://github.com/LazoCoder/Pokemon-Terminal) ⭐ 4,793 | 🐛 47 | 🌐 Python | 📅 2026-02-25 - Pokémon terminal themes for iTerm2.
* [pokecrystal](https://github.com/pret/pokecrystal) ⭐ 2,490 | 🐛 59 | 🌐 Assembly | 📅 2026-08-06 - Disassembly of Pokémon Crystal.
* [Pokemon-Go-Controller](https://github.com/kahopoon/Pokemon-Go-Controller) ⭐ 2,464 | 🐛 35 | 🌐 Swift | 📅 2023-11-03 - Play Pokémon GO safely or at unavailable area.
* [pokesprite](https://github.com/msikma/pokesprite) ⭐ 1,259 | 🐛 22 | 🌐 Python | 📅 2024-05-07 - Database of Pokémon sprites from the core series games, including custom shiny versions.
* [hyper-pokemon](https://github.com/hyper-pokemon/hyper-pokemon) ⭐ 1,246 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-23 - Wondrous, tailor-made Pokémon themes for your Hyper terminal.
* [PokeMMO](https://github.com/maierfelix/PokeMMO) ⭐ 759 | 🐛 12 | 🌐 JavaScript | 📅 2018-08-12 - WebGL Pokémon MMO Engine with Realtime Editor.
* [pogo-optimizer](https://github.com/justinleewells/pogo-optimizer) ⭐ 498 | 🐛 64 | 🌐 JavaScript | 📅 2016-07-31 - Shows you the IVs and information necessary to determine which Pokémon get ground into candy.
...
* [pokemon-reverse-engineering-tools](https://github.com/pret/pokemon-reverse-engineering-tools) ⚠️ Archived - Tools for compiling and disassembling Pokémon Red and Pokémon Crystal.
* [x-pokemon](https://github.com/passy/x-pokemon) ⭐ 92 | 🐛 3 | 🌐 HTML | 📅 2020-10-02 - A web component to display Pokémon.
* [PokemonGO-IV-Renamer](https://github.com/Boren/PokemonGO-IV-Renamer) ⚠️ Archived - Automatically renames your Pokémon to their IV stats.
* [pokemon-cli](https://github.com/sindresorhus/pokemon-cli) ⭐ 52 | 🐛 0 | 🌐 JavaScript | 📅 2024-02-29 - CLI to get Pokémon names.
* [pokemongo-game-master](https://github.com/BrunnerLivio/pokemongo-game-master) ⚠️ Archived - Collection of Pokémon GO Game Master versions.
* [alfred-pokedex](https://github.com/vutran/alfred-pokedex) ⭐ 24 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-09 - Alfred 3 workflow to lookup information about Pokémon.
* [slack-pokemon-emoji](https://github.com/fraserxu/slack-pokemon-emoji) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2016-10-20 - A tool to upload all the Pokémon to Slack emoji.
* [pokemongo-genymotion](https://github.com/jlobos/pokemongo-genymotion) ⚠️ Archived - Play Pokémon GO from your Genymotion device.
* [PoGoTools](https://github.com/nelsyeung/PoGoTools) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2016-12-26 - A set of CLI tools for getting IVs, transferring Pokémon, evolving Pokémon, and trashing items.
...
* [Pokedex](https://github.com/veekun/pokedex) ⭐ 1,523 | 🐛 145 | 🌐 Python | 📅 2022-07-21 - More than you ever wanted to know about Pokémon.
